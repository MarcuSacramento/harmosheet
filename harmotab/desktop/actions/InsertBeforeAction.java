...
public class InsertBeforeAction extends UserAction
{
    ...
    public InsertBeforeAction() {
        super(Localizer.get("MENU_INSERT_BEFORE"), ActionIcon.getIcon((byte)12));
        this.m_displayX = 0;
        this.m_displayY = 0;
        this.m_source = null;
        this.setLittleIcon(ActionIcon.getIcon((byte)13));
    }
    ...
    public void run() {
        ...
        if (selection != null) {
            ...
            final AddElementMenu menu = AddElementMenu.createInsertBefore(track, element);
            menu.populate();
